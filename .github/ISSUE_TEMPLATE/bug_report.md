...
- [ ] I understand that if this issue is about support for non-Elgato or non-Tacto hardware, it will be closed without explanation, as per issue #38, and that it should be raised in the repository of the plugin that provides support for the hardware.
